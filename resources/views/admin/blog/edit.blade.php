                    ...
                    <div class="row gap-20 masonry pos-r">
                        ...
                        <div class="masonry-item col-md-12">
                            <div class="bgc-white p-20 bd">
                                ...
                                @endif
                                <div class="mT-30">
                                    <form  action={{route('admin.blog.update',['id'=>$data[0]['id']])}} method="POST">
                                        @csrf    
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputPassword1">Blog Başlığı</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input  type="date" class="form-control" value="{{$data[0]['tarih']}}" id="exampleInputPassword1" name="tarih">
                                            </div>                                         
                                        </div>
                                </div>
                                    <div class="row">
