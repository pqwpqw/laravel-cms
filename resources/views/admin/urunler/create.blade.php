                    ...
                    <div class="row">
                        <div class="masonry-item col-md-12">
                            <div class="bgc-white p-20 bd">
                                <h4 class="c-grey-900 mB-20">Ürün Ekle</h4>
                                @if(session("status"))
                                    <div class="alert alert-primary">{{session("status")}}</div>
                                @endif
                                <div class="mT-30">
                                    <form  enctype="multipart/form-data" action="{{route('admin.urunler.store')}}" method="POST">
                                        @csrf    
                                    <div class="row">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="">Ürün Kategori ID</label>
                                                <input  type="text" class="form-control" id="" name="urunkategoriid">
                                            </div>                                         
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input  type="text" class="form-control" id="" name="fiyat">
                                            </div>                                         
                                        </div>
                                    </div>
                                    <div class="row">
